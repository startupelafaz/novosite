...
(function ($) {
    ...
    if ($('.defaultCountdown').length > 0) {
        $('.defaultCountdown').countdown('2020/06/10', function (event) {
            $(this).html(event.strftime(''
                    + '<div class="col-3 col-md-3 counter-item"><span>%D</span> Dia%!d</div>'
                    + '<div class="col-3 col-md-3 counter-item"><span>%H</span> Horas</div>'
                    + '<div class="col-3 col-md-3 counter-item"><span>%M</span> Minutos</div>'
                    + '<div class="col-3 col-md-3 counter-item"><span>%S</span> Segundos</div>'));
        });
    }
